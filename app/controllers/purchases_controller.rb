class PurchasesController < ApplicationController
  ...
  def create
    ...
    render :index and return unless @purchase_address.valid?
  ...
  def purchase_params
    params.require(:purchase_address).permit(:post_code, :prefecture_id, :city, :address, :building_name, :phone_number).merge(
